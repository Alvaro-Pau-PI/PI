    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-GETapi-products--product_id-">Get a specific product</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="reviews">
                    <a href="#reviews">Reviews</a>
                                    ...
                                    <ul id="tocify-subheader-reviews" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="reviews-POSTapi-products--product--reviews">
                                <a href="#reviews-POSTapi-products--product--reviews">Create a review</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="reviews-GETapi-products--product--reviews">
                                <a href="#reviews-GETapi-products--product--reviews">Get reviews for a product</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user-profile">
                    <a href="#user-profile">User Profile</a>
                                    ...
                                    <ul id="tocify-subheader-user-profile" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="user-profile-PUTapi-user-profile-information">
                                <a href="#user-profile-PUTapi-user-profile-information">Update profile information</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-profile-PUTapi-user-password">
                                <a href="#user-profile-PUTapi-user-password">Update password</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Returns a list of all products available in the system.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="products-GETapi-products--product_id-">Get a specific product</h2>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;description&quot;: &quot;Procesador Gaming con tecnolog&iacute;a 3D V-Cache 8 n&uacute;cleos&quot;,
    &quot;price&quot;: &quot;399.90&quot;,
    &quot;stock&quot;: 30,
    &quot;image&quot;: &quot;img/productos/CPU-AMD-7800X3D.png&quot;,
    &quot;category&quot;: &quot;Processadors&quot;,
    &quot;created_at&quot;: &quot;2026-02-04T20:42:47.000000Z&quot;,
    &quot;updated_at&quot;: &quot;2026-02-04T20:42:47.000000Z&quot;
}</code>
 </pre>
    </span>
...
<p>The ID of the product. Example: <code>1</code></p>
    ...
    <p>APIs for managing product reviews</p>

                                <h2 id="reviews-POSTapi-products--product--reviews">Create a review</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Store a new review for a product. User must be authenticated.</p>

<span id="example-requests-POSTapi-products--product--reviews">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-products--product--reviews">
            <blockquote>
...
<span id="execution-results-POSTapi-products--product--reviews" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-products--product--reviews"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-products--product--reviews"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-products--product--reviews" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-products--product--reviews">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-products--product--reviews" data-method="POST"
      data-path="api/products/{product}/reviews"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-products--product--reviews', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-products--product--reviews"
                    onclick="tryItOut('POSTapi-products--product--reviews');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-products--product--reviews"
                    onclick="cancelTryOut('POSTapi-products--product--reviews');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-products--product--reviews"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <b><code>api/products/{product}/reviews</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-products--product--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-products--product--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product"                data-endpoint="POSTapi-products--product--reviews"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="text"                data-endpoint="POSTapi-products--product--reviews"
               value=""Great product!""
               data-component="body">
    <br>
<p>The content of the review. Example: <code>"Great product!"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rating"                data-endpoint="POSTapi-products--product--reviews"
               value="5"
               data-component="body">
    <br>
<p>The rating from 1 to 5. Example: <code>5</code></p>
        </div>
        </form>

                    <h2 id="reviews-GETapi-products--product--reviews">Get reviews for a product</h2>

<p>
</p>

<p>Returns a list of reviews for a specific product.</p>

<span id="example-requests-GETapi-products--product--reviews">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-products--product--reviews">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-products--product--reviews" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products--product--reviews"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products--product--reviews"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-products--product--reviews" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products--product--reviews">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-products--product--reviews" data-method="GET"
      data-path="api/products/{product}/reviews"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-products--product--reviews', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products--product--reviews"
                    onclick="tryItOut('GETapi-products--product--reviews');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products--product--reviews"
                    onclick="cancelTryOut('GETapi-products--product--reviews');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products--product--reviews"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-products--product--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-products--product--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product"                data-endpoint="GETapi-products--product--reviews"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
    ...
    <p>APIs for managing user profile</p>
                                ...
                                <h2 id="user-profile-PUTapi-user-profile-information">Update profile information</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-user-profile-information"
               value="John Doe"
               data-component="body">
    <br>
<p>The new name. Example: <code>John Doe</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-user-profile-information"
               value="john@example.com"
               data-component="body">
    <br>
<p>The new email. Example: <code>john@example.com</code></p>
        </div>
        </form>

                    <h2 id="user-profile-PUTapi-user-password">Update password</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The current password. Example: <code>password</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
